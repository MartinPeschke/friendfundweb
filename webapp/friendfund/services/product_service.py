...
class ProductService(object):
    ...
    def search_tab_search(self, request):
        ...
        if tmpl_context.searchterm.startswith("http://") and tmpl_context.amazon_available:
            ...
            tmpl_context.searchresult = self.amazon_region_map[tmpl_context.region].get_products_from_search(
                tmpl_context.searchterm, page_no = tmpl_context.page, sorting=tmpl_context.sort)
        return tmpl_context
