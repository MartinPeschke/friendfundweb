...
set -e
export PYTHONPATH="/opt/www/ff_gad_live:/home/www-data/instances/gad_celery_curr"
DEFAULT_CELERYD="/server/pylons1.0/bin/celeryd"
CELERYD="/server/pylons1.0/bin/celeryd"
CELERYD_LOG_FILE="/opt/www/ff_gad_live/logs/celeryd_live.log"
CELERYD_PID_FILE="/opt/www/ff_gad_live/run/celeryd_live.pid"
CELERYD_CHDIR="/opt/www/ff_gad_live"
