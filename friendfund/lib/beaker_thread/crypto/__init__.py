...
from friendfund.lib.beaker_thread.crypto.pbkdf2 import PBKDF2, strxor
from friendfund.lib.beaker_thread.crypto.util import hmac, sha1, hmac_sha1, md5
...
if util.jython:
    try:
        from friendfund.lib.beaker_thread.crypto.jcecrypto import getKeyLength, aesEncrypt
        keyLength = getKeyLength()
    except ImportError:
        pass
else:
    try:
        from friendfund.lib.beaker_thread.crypto.pycrypto import getKeyLength, aesEncrypt, aesDecrypt
        keyLength = getKeyLength()
    except ImportError:
        pass
