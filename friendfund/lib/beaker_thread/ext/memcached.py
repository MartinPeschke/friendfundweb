from friendfund.lib.beaker_thread.container import NamespaceManager, Container
from friendfund.lib.beaker_thread.exceptions import InvalidCacheBackendError, MissingCacheParameter
from friendfund.lib.beaker_thread.synchronization import file_synchronizer, null_synchronizer
from friendfund.lib.beaker_thread.util import verify_directory, SyncDict
import warnings
import thread
memcache = None
...
class MemcachedNamespaceManager(NamespaceManager):
    ...
    def __init__(self, namespace, url=None, data_dir=None, lock_dir=None, **params):
        ...
        self.mc = MemcachedNamespaceManager.clients.get('%s:%s' % (url, thread.get_ident()), memcache.Client, url.split(';'))
