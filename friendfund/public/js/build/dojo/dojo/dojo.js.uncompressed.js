...
if(!dojo._hasResource["ff.w"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["ff.w"] = true;
dojo.provide("ff.w");
...
if(!dojo._hasResource["ff.io"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["ff.io"] = true;
dojo.provide("ff.io");
...
if(!dojo._hasResource["ff.parser"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["ff.parser"] = true;
